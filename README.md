...
R0VM Helios has received an idependent security audit from zkSecurity. The reports is available in the [`rz-security` repo](https://github.com/risc0/rz-security/tree/main/audits/r0vm-helios).
